...
use core::{panic::PanicInfo, unimplemented};

use kevin_os::{exit_qemu, serial_println};
...
lazy_static!{
    static ref TEST_IDT:InterruptDescriptorTable = {
        ...
        unsafe {
            ...
            .set_stack_index(kevin_os::gdt::DOUBLE_FAULT_IST_INDEX);
        }
        idt
    };
}
...
extern "x86-interrupt" fn test_double_fault_handler(_stack_frame:InterruptStackFrame,_error_code:u64)->!{
    serial_println!("[ok]");
    exit_qemu(kevin_os::QemuExitCode::Succeed);
    loop {
